...
const searchId = (categoriesTree, id) =>
  categoriesTree.find((d) => d.id === id) || searchId(categoriesTree.children);

console.log(searchId(categoriesTree, 'b47b2bbc-df04-4c15-8016-ac4dbcf33cca'));
